          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2.5 pr-10 rounded-lg bg-gray-800 border border-gray-700 text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 text-sm transition"
                placeholder="••••••••"
              />
              <button
                type="button"
